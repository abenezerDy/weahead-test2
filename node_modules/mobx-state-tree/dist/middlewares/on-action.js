...
import { getStateTreeNode, isStateTreeNode, addMiddleware, tryResolve, applyPatch, getType, applySnapshot, isRoot, isProtected, fail, isPlainObject, isPrimitive, isArray, asArray, getRelativePathBetweenNodes, warnError } from "../internal";
...
export function applyAction(target, actions) {
    ...
    if (process.env.NODE_ENV !== "production") {
        ...
        if (typeof actions !== "object")
            throw fail("expected second argument to be an object or array, got " + actions + " instead");
    }
